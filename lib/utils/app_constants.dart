...
class AppConstants {
  static const String APP_NAME = 'JBFMS Serviceman';
  static const String APP_USER = 'Serviceman App';
  static const String APP_VERSION = '1.2';
  static const String BASE_URL = 'https://jbfms.co.in/newjbfms';
  ...
  static const String UPDATE_PASSWORD_URI =
      '/api/v1/serviceman/profile/change-password';
  static const String UPDATE_PROFILE_URI = '/api/v1/serviceman/update/profile';
  static const String NOTIFICATION_URI =
      '/api/v1/serviceman/push-notifications';
  static const String BOOKING_DETAILS_URI = '/api/v1/serviceman/booking/detail';
  static const String STATUS_UPDATE_URI =
      '/api/v1/serviceman/booking/status-update';
  static const String FORGOT_PASS_URI = '/api/v1/serviceman/forgot-password';
  static const String OTP_VERIFICATION_URI =
      '/api/v1/serviceman/otp-verification';
  ...
  static const String PAYMENT_STATUS_UPDATE =
      '/api/v1/serviceman/booking/payment-status-update';
