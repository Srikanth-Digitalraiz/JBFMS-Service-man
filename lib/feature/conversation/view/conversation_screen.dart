...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<ConversationController>(initState: (state) {
            ...
            : Column(
                children: [
                  conversationController.conversationList!.length > 0
                      ? Expanded(
                          child: ListView.builder(
                            controller:
                                conversationController.messageScrollController,
                            padding:
                            ...
                            itemBuilder: (context, index) {
                              bool isRightMessage = conversationController
                                      .conversationList!
                                      .elementAt(index)
                                      .userId ==
                                  customerID;
                  ...
                  conversationController.pickedImageFile != null &&
                          conversationController.pickedImageFile!.length > 0
                      ? Container(
                          height: 90,
                          width: Get.width,
