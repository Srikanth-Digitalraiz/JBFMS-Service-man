  ...
  static Widget buildCustomerAddress(
      ...
      Column(
        ...
        children: [
          ...
          Text(
              "Payment Status: ${bookingDetailsContent.isPaid.toString() == '0' ? 'Unpaid' : 'Paid'}",
            ...
            child: Column(
              ...
              children: [
                ...
                buildText(
                  ...
                  value:
                      "(-) ${controller.totalDiscountWithCoupon.toStringAsFixed(2)}",
                  unite: true,
                ),
                buildText(
                  title: 'Tax',
                  value:
                      "(+) ${double.tryParse(bookingDetailsContent.totalTaxAmount)!.toStringAsFixed(2)}",
                  unite: true,
                ),
                Divider(),
                buildText(
                  ...
                  value: double.tryParse(
                          controller.bookingDetailsContent!.totalBookingAmount)!
                      .toStringAsFixed(2),
                  unite: true,
                ),
              ],
